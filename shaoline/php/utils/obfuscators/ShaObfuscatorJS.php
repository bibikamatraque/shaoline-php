...
class ShaObfuscatorJS implements IShaObfuscator {
	...
	public function config($_script, $_encoding = 0, $_fastDecode = true, $_specialChars = false){
		//$this->_script = $_script;
		$shaMinimizerJS = new ShaMinimizerJS();
		$shaMinimizerJS->config($_script);
		$this->_script = $shaMinimizerJS->pack();
	...
	private function _bootStrap($packed, $keywords) {
        ...
        $unpackPacker = new ShaObfuscatorJS();
        $unpackPacker->config($unpack, 0, false, true);
