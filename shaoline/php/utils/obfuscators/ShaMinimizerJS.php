<?php
class ShaMinimizerJS implements IShaObfuscator {
	...
	protected $options;
	/**
	 * Contains the default options for minification.
	 * This array is merged with
	...
	public function pack() {
		return $this->minify ($this->input, array('flaggedComments' => false)).";";
	}
	 ...
	 * @return bool|string
	 */
	public function minify($js, $options = array()) {
		try {
			ob_start ();
	 ...
	 * This function loops through the input string,
	 ...
	 * Another reason for this is to make sure
