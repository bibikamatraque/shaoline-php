    ...
    public static function draw() {
        ...
        foreach ($specificJsFiles as $specificJsFile) {
            if (trim($specificJsFile)!="") {
                $tmpFile = ShaUtilsString::replace($specificJsFile, "[CACHE_SUFFIX]", ShaPage::getCacheSuffix());
                echo '<script type="text/javascript" src="'.$tmpFile.'"></script>'.PHP_EOL;
            }
        ...
        foreach ($specificCssFiles as $specificCssFile) {
            if (trim($specificCssFile)!="") {
                $tmpFile = ShaUtilsString::replace($specificCssFile, "[CACHE_SUFFIX]", ShaPage::getCacheSuffix());
                echo '<link type="text/css" rel="stylesheet" href="'.$tmpFile.'" />'.PHP_EOL;
            }
        }
            ...
            return "
                <div id='cms_admin_block' $cssStyle>
                    <div id='cms_admin_block_internal'>
                        <a class='goto_admin_page' $gotoAdminPageCssSyle href='".ShaContext::getAdminPath()."' >".ShaContext::t("gotoAdminPage")."</a>
